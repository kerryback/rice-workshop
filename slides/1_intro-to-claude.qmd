...
::: {.two-cards}
::: {.card-blue}
[Consumer plans --- Free, Pro, Max (what we are on)]{.card-title}

- [Settings > Privacy > Privacy Settings]{.accent}, then turn off [Help improve Claude]{.accent}
- Direct link: [claude.ai/settings/data-privacy-controls](https://claude.ai/settings/data-privacy-controls){target="_blank"}
- The default on a personal account is on
- Off keeps your data 30 days; on keeps it five years
:::
::: {.card-amber}
[Commercial plans --- Claude for Work, Education, API]{.card-title}
...
::: {.explainer}
It is one [account]{.accent} setting, not an app setting: it covers Chat, Cowork, the command line, and the Academic Studio extension at once. And it is not in the Anthropic developer console --- that is a separate product for API keys.
:::
...
[tesla.pptx](../files/session1/tesla.pptx){target="_blank"}
:::
...
Result
:::
[amortization.xlsx](../files/session1/amortization.xlsx){target="_blank"}
:::
...
## Example: Data Wrangling, Charts, Documents {.section-divider}
...
|---|---|---|
| [northwind_customers.xlsx](../files/session1/northwind_customers.xlsx){target="_blank"} | 93 | CustomerID, CompanyName, Country |
| [northwind_orders.xlsx](../files/session1/northwind_orders.xlsx){target="_blank"} | 500 | OrderID, CustomerID, OrderDate |
| [northwind_orderdetails.xlsx](../files/session1/northwind_orderdetails.xlsx){target="_blank"} | 18,976 | OrderID, ProductID, UnitPrice, Quantity |
| [northwind_products.xlsx](../files/session1/northwind_products.xlsx){target="_blank"} | 77 | ProductID, ProductName, CategoryID |
| [northwind_categories.xlsx](../files/session1/northwind_categories.xlsx){target="_blank"} | 8 | CategoryID, CategoryName |
...
::: {.card .card-dark}
Watch the three-minute video [academic_studio.mp4](../files/session1/academic_studio.mp4){target="_blank"}
:::
