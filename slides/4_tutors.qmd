...
- At start of class enter [/poll]{.accent} in Claude in the classroom computer.  Brings up a QR code in browser.
- Students connect
- During class, either [/poll `<filename>`]{.accent} for prepared poll or [/poll `<question>`]{.accent} for on-the-spot
...
- Enter [/screenshare]{.accent} on the classroom computer
