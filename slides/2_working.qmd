...
::: {.card-dark}
Include instructions in the skill for Claude to automatically save changes and close before editing and then reopen.
:::
...
::: {.highlight-box}
Skills announce when they apply, and sometimes two of them claim the same job. Anthropic's `pptx` skill triggers on [any]{.accent} PowerPoint file, so a skill of your own for your desired style will collide with it. 
:::
