...
::: {.two-cards}
::: {.card .card-blue}
[Out-of-class assignments]{.card-title}
...
participation, presentations, quizzes, "solutions" to problems that they can evaluate with basic calculators or paper and pencil
:::
:::
...
- Python OCR + Claude image viewing until text is coherent 
:::
:::
...
:::
::: {.step-desc}
You provide the grading rubric (maybe a filename) and the name of the folder containing assignments
:::
:::
:::
...
- I will ask you to install several plugins I've created
...
:::
::: {.step-desc}
Need pptx for speaker notes, PDF for images.
:::
:::
::: {.step-card .fragment}
::: {.step-icon}
...
:::
::: {.step-desc}
Feed narration per slide to ElevenLabs and get MP3
:::
:::
::: {.step-card .fragment}
::: {.step-icon}
...
- Convenient to set ElevenLabs inputs (voice, style, ...)
- Claude can write a web app, save, and deploy locally
:::
:::

::: {.highlight-box}
Ask Claude to add the plugin marketplace [github.com/kerryback/skills]{.accent} (only need to do that once) and then to install [voiceover@kerryback-skills]{.accent}.
:::
...
- Then it should draft narration as speaker notes in the pptx file
...
Tell Claude to install [participation@kerryback-skills]{.accent}
:::
::: {.card .card-amber}
...
:::
::: {.step-desc}
Ask Claude to install [poll@kerryback-skills]{.accent}.
:::
:::
::: {.step-card .fragment}
::: {.step-icon}
...
Similar to polling: QR Code, instructor's panel allows selection of student to share, then that student's screen appears on the panel and is projected.  Reverse tunnel is in [screenshare@kerryback-skills]{.accent}
