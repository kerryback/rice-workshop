...
The most useful things will be the ones you create (with Claude's assistance) --- for example, a code script that you know works and a SKILL.md that tells Claude when to use it
:::
:::
...
- Can easily involve other providers for more diversity - ChatGPT and Gemini, for example.  Can still use Claude Code as the orchestrator
