...
:::
::: {.step-desc}
How many subagents (or other models), how many rounds, what to do if there is disagreement, how to record the grades, how to provide info about the grounds for grades
:::
:::
::: {.step-card}
::: {.step-icon}
